...
// Waze-inspired color palette
const CYAN_MAIN = "#00c8ff";
const CYAN_LIGHT = "#33d4ff";
const CYAN_DARK = "#00a3cc";

const ORANGE_MAIN = "#ff6600";
const ORANGE_LIGHT = "#ff8533";
const ORANGE_DARK = "#cc5200";
...
const shapeConfig = { borderRadius: 12 };
...
const buildComponents = (primaryMain: string) => ({
  ...
  MuiButton: {
    styleOverrides: {
      ...
      contained: {
        ...
        "&:hover": {
          boxShadow: `0 6px 20px ${alpha(primaryMain, 0.5)}`,
        },
      },
    },
  },
  ...
  MuiFab: {
    styleOverrides: {
      root: {
        boxShadow: `0 4px 20px ${alpha(primaryMain, 0.4)}, 0 8px 40px ${alpha(primaryMain, 0.2)}`,
        "&:hover": {
          boxShadow: `0 8px 30px ${alpha(primaryMain, 0.55)}, 0 12px 48px ${alpha(primaryMain, 0.3)}`,
        },
      },
    },
  },
...
export const lightTheme = createTheme({
  ...
  components: buildComponents(CYAN_MAIN),
});
