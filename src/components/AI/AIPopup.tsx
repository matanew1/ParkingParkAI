...
const AIPopup: React.FC<AIPopupProps> = ({ isOpen, onClose }) => {
  ...
  const aiOptions: AIOption[] = [
    ...
    },
    {
      ...
      description:
        "Get AI predictions for parking availability in the next few hours",
    ...
    },
    {
      ...
      title: "Optimal Route",
      description:
        "AI will suggest the optimal driving route with parking options",
              ...
              {loadingAction ? (
                ...
                <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-lg">
                  <p className="text-xs text-gray-800 dark:text-gray-300">
                    AI recommendation ready! This is where the AI results would
                    appear.
                  </p>
